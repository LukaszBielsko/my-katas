...
// function calculateDamage(myType, opponentType, myAttack, opponentsDefense) {
//   let effectiveness;
//   if (myType === "fire") {
...
//   return 50 * (myAttack / opponentsDefense) * effectiveness;
// }
// fire > grass
// fire < water
// fire = electric
...
// t's a Pokemon battle! Your task is to calculate the damage that a particular move would do using the following formula (not the actual one from the game):
